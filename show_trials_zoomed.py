...
ax = plt.errorbar(df.index*5, 100.0*df['success'], yerr=[100.0*(df['success']-df['lower']), 100.0*(df['upper']-df['success'])], fmt="o", ecolor="red", capthick=1000).lines
...
plt.ylabel("Eye Spy %")
plt.yticks(ticks=[60.0, 70.0, 80.0, 90.0, 100.0], labels=["60%", "70%", "80%", "90%", "100%"])
